...
if not st.session_state.auth["logged_in"]:
    ...
    if st.session_state.auth["role"] == "admin":
        ...
        # List of all schools (without pandas)
    ...
    # ================= SCHOOL DASHBOARD =================
                ...
                if st.form_submit_button("Add Student"):
                    if not name or not parent or not phone:
                        ...
                        run_query(
                            ...
                            (str(uuid.uuid4()), name, blood, allergy, parent, phone, ppass,
                             likes, dislikes, "", class_, sid)
                        )
            ...
            with st.form("fee_form"):
                ...
                if st.form_submit_button("Add Fee Record"):
                    run_query(
                        ...
                        (str(uuid.uuid4()), student_map[student_name], student_name, amount,
                         month, "Pending", "", sid)
                    )
        ...
        # -------- INVENTORY --------
            ...
            with col2:
                category = st.selectbox("Category", ["General", "Stationery", "Food", "Uniform", "Medicine"])
            with col3:
                qty = st.number_input("Current Quantity", min_value=0, value=10)
